...
namespace QLCHBanXeMay
{
    public partial class frmLoaixe : Form
    {
        ...
        private void Load_DataGridView()
        {
            ...
            dgvLoaixe.DataSource = tblTheLoai;

            //do dl tu bang vao datagridview

            dgvLoaixe.Columns[0].HeaderText = "Mã loại";
            dgvLoaixe.Columns[1].HeaderText = "Tên loại";
            dgvLoaixe.Columns[0].Width = 100;
            dgvLoaixe.Columns[1].Width = 300;
            // Không cho phép thêm mới dữ liệu trực tiếp trên lưới
            dgvLoaixe.AllowUserToAddRows = false;
            // Không cho phép sửa dữ liệu trực tiếp trên lưới
            dgvLoaixe.EditMode = DataGridViewEditMode.EditProgrammatically;
        }
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            sql = "SELECT MaLoai FROM tblTheLoai WHERE MaLoai=N'" +
            txtMaloai.Text.Trim() + "'";
            ...
            sql = "INSERT INTO tblTheLoai(MaLoai,TenLoai) VALUES('" +
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            sql = "UPDATE MaLoai SET TenLoai=N'" + txtTenloai.Text.ToString() +
        ...
        private void dgvLoaixe_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            txtMaloai.Text = dgvLoaixe.CurrentRow.Cells["MaLoai"].Value.ToString();
            txtTenloai.Text = dgvLoaixe.CurrentRow.Cells["TenLoai"].Value.ToString();
            btnSua.Enabled = true;
            btnXoa.Enabled = true;
        ...
        private void txtMaloai_KeyUp_1(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
                SendKeys.Send("{TAB}");
        ...
        private void txtTenloai_KeyUp_1(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
                SendKeys.Send("{TAB}");
        ...
        private void dgvLoaixe_Click_1(object sender, EventArgs e)
        {
            if (btnThem.Enabled == false)
            {
                MessageBox.Show("Đang ở chế độ thêm mới!", "Thông báo",
        ...
        private void txtMaloai_KeyUp_2(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
                SendKeys.Send("{TAB}");
        }

        private void txtTenloai_KeyUp_2(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
                SendKeys.Send("{TAB}");
        }
